# Generated by Django 5.1.1 on 2024-11-19 10:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0024_remove_productimage_product_remove_rental_features_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('features', models.ManyToManyField(blank=True, to='main.rentalfeature')),
            ],
        ),
        migrations.CreateModel(
            name='RentalImage',
            fields=[
                ...
                ('rental', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='main.rental')),
            ],
        ),
    ]
